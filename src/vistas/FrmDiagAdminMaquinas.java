...
public class FrmDiagAdminMaquinas extends javax.swing.JDialog {

    DefaultTableModel modeloTabla;
    AdminMaquinasDB objAdminMaquinasDB = new AdminMaquinasDB();

    public FrmDiagAdminMaquinas(java.awt.Frame parent, boolean modal) {
    ...
    private void configurarTabla() {
        String cabecera[] = {"ID", "Nombre ", "Referencia"};
        String datos[][] = {};
        ...
        this.tblListaDeMaquinas.setModel(this.modeloTabla);
    }
    ...
    private void refrescarTabla() {
        ...
        for (Object obj : objAdminMaquinasDB.listarTodo()) {
            Maquinas objMaquinas = (Maquinas) obj;
            filaDeTabla[0] = Integer.toString(objMaquinas.getIdm());
            filaDeTabla[1] = objMaquinas.getNombre_m();
            filaDeTabla[2] = objMaquinas.getReferencia_m();
    ...
    private void initComponents() {
        ...
        tblListaDeMaquinas = new javax.swing.JTable();
        ...
        tblListaDeMaquinas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane1.setViewportView(tblListaDeMaquinas);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        FrmDiagAgregarMaquinas FrmDiagAgregarMaquinas = new FrmDiagAgregarMaquinas(null, true);
        FrmDiagAgregarMaquinas.setLocationRelativeTo(null);
        FrmDiagAgregarMaquinas.setVisible(true);

        this.refrescarTabla();
    }//GEN-LAST:event_btnAgregarActionPerformed

    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        int fila = this.tblListaDeMaquinas.getSelectedRow();

        if (fila > -1) {
            int id = Integer.parseInt(this.tblListaDeMaquinas.getValueAt(fila, 0).toString());

            FrmDiagActualizarMaquinas objFrmDiagUpdArts = new FrmDiagActualizarMaquinas(null, true, id);
            ...
            JOptionPane.showMessageDialog(this, "Por favor, seleccione la maquina que quiere actualizar.");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fila > -1) {
            int idm = Integer.parseInt(this.tblListaDeMaquinas.getValueAt(fila, 0).toString());

            Maquinas objMaquinas = new Maquinas();
            objMaquinas.setIdm(idm);

            if (objAdminMaquinasDB.eliminar(objMaquinas)) {
                JOptionPane.showMessageDialog(this, "La maquina fue eliminada con éxito.");
            } else {
                JOptionPane.showMessageDialog(this, "La maquina no pudo ser eliminada.");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione la maquina que quiere eliminar.");
        }
    ...
    private javax.swing.JTable tblListaDeMaquinas;
