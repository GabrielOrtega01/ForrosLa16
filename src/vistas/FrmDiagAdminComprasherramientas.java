...
import modelo.ComprasherramientasVista;

public class FrmDiagAdminComprasherramientas extends javax.swing.JDialog {

    DefaultTableModel modeloTabla;
    AdminComprasherramientasDB objAdminComprasDB = new AdminComprasherramientasDB();

    public FrmDiagAdminComprasherramientas(java.awt.Frame parent, boolean modal) {
    ...
    private void configurarTabla() {
        String cabecera[] = {"ID", "Valor", "Iva", "Proveedor", "Herramienta", "Fecha"};
        String datos[][] = {};
    ...
    private void refrescarTabla() {
        ...
        for (Object obj : objAdminComprasDB.listarTodo2()) {
            ComprasherramientasVista objCompras = (ComprasherramientasVista) obj;
            filaDeTabla[0] = Integer.toString(objCompras.getIdch());
            filaDeTabla[1] = Integer.toString(objCompras.getValor_ch());
            filaDeTabla[2] = Float.toString(objCompras.getIva_ch());
            filaDeTabla[3] = objCompras.getProveedor();
            filaDeTabla[4] = objCompras.getHerramienta();
            filaDeTabla[5] = objCompras.getFecha_ch().format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Compras Herramientas");
        ...
        tblListaDeCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Valor", "Fecha", "Iva", "Proveedor", "Herramienta"
            }
        ));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        FrmDiagAgregarComprasherramientas objFrmDiagAgregarCompras = new FrmDiagAgregarComprasherramientas(null, true);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (fila > -1) {
            ...
            FrmDiagActualizarComprasherramientas objFrmDiagUpdArts = new FrmDiagActualizarComprasherramientas(null, true, id);
            ...
            JOptionPane.showMessageDialog(this, "Por favor, seleccione la compra de la herramienta que quiere actualizar.");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fila > -1) {
            int idch = Integer.parseInt(this.tblListaDeCompras.getValueAt(fila, 0).toString());

            Comprasherramientas objCompras = new Comprasherramientas();
            objCompras.setIdch(idch);

            if (objAdminComprasDB.eliminar(objCompras)) {
                JOptionPane.showMessageDialog(this, "La compra de la herramienta fue eliminada con éxito.");
            } else {
                JOptionPane.showMessageDialog(this, "La compra de la herramienta no pudo ser eliminada.");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione la compra de la herramienta que quiere eliminar.");
        }
