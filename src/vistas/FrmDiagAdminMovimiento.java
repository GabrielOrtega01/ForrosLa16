...
public class FrmDiagAdminMovimiento extends javax.swing.JDialog {

    DefaultTableModel modeloTabla;
    AdminMovimientoDB objAdminMovimientoDB = new AdminMovimientoDB();

    public FrmDiagAdminMovimiento(java.awt.Frame parent, boolean modal) {
    ...
    private void configurarTabla() {
        String cabecera[] = {"ID", "Cantidad ", "Servicio", "Empleado", "Vehículo", "Producto"};
        String datos[][] = {};
        ...
        this.tblListaDeMovimiento.setModel(this.modeloTabla);
    }
    ...
    private void refrescarTabla() {
        ...
        for (Object obj : objAdminMovimientoDB.listarTodo2()) {
            MovimientoVista objMovimiento = (MovimientoVista) obj;
            filaDeTabla[0] = Integer.toString(objMovimiento.getIdmov());    
            filaDeTabla[1] = Integer.toString(objMovimiento.getCantidad_producto());
            filaDeTabla[2] = objMovimiento.getServicio();
            filaDeTabla[3] = objMovimiento.getEmpleado();
            filaDeTabla[4] = objMovimiento.getVehiculo();
            filaDeTabla[5] = objMovimiento.getProducto();
    ...
    private void initComponents() {
        ...
        tblListaDeMovimiento = new javax.swing.JTable();
        ...
        tblListaDeMovimiento.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "Cantidad", "Servicio", "Empleado", "Vehículo", "Producto"
            }
        ));
        jScrollPane1.setViewportView(tblListaDeMovimiento);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        FrmDiagAgregarMovimiento objFrmDiagAgregarMovimiento = new FrmDiagAgregarMovimiento(null, true);
        objFrmDiagAgregarMovimiento.setLocationRelativeTo(null);
        objFrmDiagAgregarMovimiento.setVisible(true);

        this.refrescarTabla();
    }//GEN-LAST:event_btnAgregarActionPerformed

    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        int fila = this.tblListaDeMovimiento.getSelectedRow();

        if (fila > -1) {
            int id = Integer.parseInt(this.tblListaDeMovimiento.getValueAt(fila, 0).toString());

            FrmDiagActualizarMovimiento objFrmDiagUpdArts = new FrmDiagActualizarMovimiento(null, true, id);
            ...
            JOptionPane.showMessageDialog(this, "Por favor, seleccione el movimiento que quiere actualizar.");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fila > -1) {
            int idmov = Integer.parseInt(this.tblListaDeMovimiento.getValueAt(fila, 0).toString());

            Movimiento objMovimiento = new Movimiento();
            objMovimiento.setIdmov(idmov);

            if (objAdminMovimientoDB.eliminar(objMovimiento)) {
    ...
    private javax.swing.JTable tblListaDeMovimiento;
