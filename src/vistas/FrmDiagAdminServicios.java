...
public class FrmDiagAdminServicios extends javax.swing.JDialog {

    DefaultTableModel modeloTabla;
    AdminServiciosDB objAdminServiciosDB = new AdminServiciosDB();

    public FrmDiagAdminServicios(java.awt.Frame parent, boolean modal) {
    ...
    private void configurarTabla() {
        String cabecera[] = {"ID", "Nombre", "Costo"};
        String datos[][] = {};
        ...
        this.tblListaDeServicios.setModel(this.modeloTabla);
    }
    ...
    private void refrescarTabla() {
        ...
        String filaDeTabla[] = new String[3];

        for (Object obj : objAdminServiciosDB.listarTodo()) {
            Servicios objServicios = (Servicios) obj;
            filaDeTabla[0] = Integer.toString(objServicios.getIds());
            filaDeTabla[1] = objServicios.getNombre_s();
            filaDeTabla[2] = Integer.toString(objServicios.getCosto_s());
    ...
    private void initComponents() {
        ...
        tblListaDeServicios = new javax.swing.JTable();
        ...
        tblListaDeServicios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane1.setViewportView(tblListaDeServicios);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        FrmDiagAgregarServicios FrmDiagAgregarServicios = new FrmDiagAgregarServicios(null, true);
        FrmDiagAgregarServicios.setLocationRelativeTo(null);
        FrmDiagAgregarServicios.setVisible(true);

        this.refrescarTabla();
    }//GEN-LAST:event_btnAgregarActionPerformed

    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        int fila = this.tblListaDeServicios.getSelectedRow();

        if (fila > -1) {
            int id = Integer.parseInt(this.tblListaDeServicios.getValueAt(fila, 0).toString());

            FrmDiagActualizarServicios objFrmDiagUpdArts = new FrmDiagActualizarServicios(null, true, id);
            ...
            JOptionPane.showMessageDialog(this, "Por favor, seleccione el servicio que quiere actualizar.");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fila > -1) {
            int ids = Integer.parseInt(this.tblListaDeServicios.getValueAt(fila, 0).toString());

            Servicios objServicios = new Servicios();
            objServicios.setIds(ids);

            if (objAdminServiciosDB.eliminar(objServicios)) {
                JOptionPane.showMessageDialog(this, "El servicio fue eliminado con éxito.");
            } else {
                JOptionPane.showMessageDialog(this, "El servicio no pudo ser eliminado.");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione el servicio que quiere eliminar.");
        }
        this.refrescarTabla();
    ...
    private javax.swing.JTable tblListaDeServicios;
