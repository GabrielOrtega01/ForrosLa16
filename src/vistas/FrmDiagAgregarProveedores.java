...
public class FrmDiagAgregarProveedores extends javax.swing.JDialog {

    public FrmDiagAgregarProveedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 40, 40));
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 40, 40));
        ...
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 150, -1));
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        AdminProveedoresDB objAdmCliDB = new AdminProveedoresDB();
        Proveedores objProveedores = new Proveedores();

        objProveedores.setNombre_prov(nombre);

        objAdmCliDB.insertar(objProveedores);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDiagAgregarProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDiagAgregarProveedores dialog = new FrmDiagAgregarProveedores(new javax.swing.JFrame(), true);
