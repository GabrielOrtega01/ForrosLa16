...
public class FrmDiagActualizarProveedores extends javax.swing.JDialog {

    AdminProveedoresDB objAdmCliDB = new AdminProveedoresDB();
    private int idprov;

    public FrmDiagActualizarProveedores(java.awt.Frame parent, boolean modal, int idprov) {
        super(parent, modal);
        initComponents();
        this.idprov = idprov;
        this.cargarProveedores(idprov);
    }

    private void cargarProveedores(int idveh) {
        Proveedores objProveedores = new Proveedores();
        objProveedores.setIdprov(idveh);

        objProveedores = (Proveedores) objAdmCliDB.listarUno(objProveedores);

        this.txtNombre.setText(objProveedores.getNombre_prov());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualizar Porveedor");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        objProveedores.setIdprov(this.idprov);
        objAdmCliDB.listarUno(objProveedores);

        objProveedores.setNombre_prov(nombre);

        objAdmCliDB.actualizar(objProveedores);
