...
public class FrmDiagAgregarHerramientas extends javax.swing.JDialog {

    public FrmDiagAgregarHerramientas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 40, 40));
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        objAdmCliDB.insertar(objHerramientas);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDiagAgregarHerramientas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDiagAgregarHerramientas dialog = new FrmDiagAgregarHerramientas(new javax.swing.JFrame(), true);
